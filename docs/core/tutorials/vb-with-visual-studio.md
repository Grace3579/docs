...
description: Learn how to create and build a simple .NET Core console application with Visual Basic using Visual Studio 2017.
author: rpetrusha
ms.author: ronpet
ms.date: 08/07/2017
dev_langs:
...
---
# Create and Build a Visual Basic Hello World application with the .NET Core SDK in Visual Studio 2017
