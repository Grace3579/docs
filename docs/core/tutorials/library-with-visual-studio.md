---
title: Create and Build a C# .NET Standard library with  Visual Studio 2017
...
---
# Create and Build a .NET Standard library with C# and the .NET Core SDK in Visual Studio 2017
